...
from .contracts import Multicall2, MocCABag, MoCMedianizer
...
class Automator(PendingTransactionsTasksManager):
    ...
    def calculate_ema(self, task=None, global_manager=None, task_result=None):
        ...
        if self.contracts_loaded["MocCABag"].sc.functions.shouldCalculateEma().call():
            ...
            try:
                tx_hash = self.contracts_loaded["MocCABag"].update_emas(
    ...
    def run_settlement(self, task=None, global_manager=None, task_result=None):
        ...
        get_bts = self.contracts_loaded["MocCABag"].sc.functions.getBts().call()
        if get_bts > 0:
            ...
            try:
                tx_hash = self.contracts_loaded["MocCABag"].run_settlement(
